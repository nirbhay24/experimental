...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        DatagramSocket socket = sendDnsRequest(ipAddress, domain);


        handleDnsResponse(socket);
    }

    private static DatagramSocket sendDnsRequest(InetAddress ipAddress, String domain) throws IOException {
    ...
    private static void handleDnsResponse(DatagramSocket socket) throws IOException {
        short ANCOUNT;
        short ARCOUNT;
        short NSCOUNT;
        short QDCOUNT;
