...
@Configuration
@EnableJpaRepositories(basePackages = "org.example.shard.model.shard",
        entityManagerFactoryRef = "shard1EntityManagerFactory",
        transactionManagerRef = "shard1TransactionManager" )
@EntityScan(basePackages = "org.example.shard.model.shard")
public class ShardConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean shard1EntityManagerFactory()
    {
        ...
        factory.setPackagesToScan(new String[]{"org.example.shard.model.shard"});
